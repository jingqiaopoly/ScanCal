function cor = NIST3_fwd_s( raw, par )
%NIST2_fwd    Scanner forward model polar-to-polar NIST simplified
%
%   C = NIST3_fwd_s(R, par) converts the raw encoder/LiDAR unit readings
%   R to corrected polar coordinates C with respect to the scanner's
%   own coordinate system (SOCS) using the NIST3 scanner model par.
%
...
%
%   par is a structure of NIST3 model parameters as created using NIST3_create
%
%   See also NIST3_create, NIST3_get, NIST3_set, NIST3_bwd
